...
import Codename from './Images/Codenames.png'
  ...
  return(
    <div className="Home">
      <div className="project-list">
        <h1 className="project-name">2022 - <span className="project-title">Codenames</span></h1>
        <h1 className="project-name">2021 - <span className="project-title">tvGuidance</span></h1> 
      </div>
      <Slider {...settings} className="slider">
          <img className='ProjImg' src={Codename} alt="CodenamesPhoto"></img>
